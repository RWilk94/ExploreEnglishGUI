  ...
  public void webScrap(final EtutorExercise etutorExercise, final WebDriver driver) throws JsonProcessingException {
    ...
    while (true) {
      ...
      final EtutorExerciseItem exerciseItem = EtutorExerciseItem.builder()
        ...
        .questionSecondarySound(extractAmericanAudioButton(exercise))
        .questionPrimarySound(extractBritishAudioButton(exercise))
        .finalAnswer(extractCorrectAnswer(exercise).getLeft())
        .translation(extractCorrectAnswer(exercise).getRight())
        .description(null)
        .answerSecondarySound(extractAmericanAudioButton(exercise))
        .answerPrimarySound(extractBritishAudioButton(exercise))
